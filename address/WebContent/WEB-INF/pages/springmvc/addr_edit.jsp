    	  	    ...
    	  	    <div class="rightMenuTitle">
    	  	     ...
    	  	     <form action=""  method="post">
	    	  	     ...
	    	  	     <table>	    	  	     	  
	    	  	     	  ...
	    	  	     	  <tr>
	    	  	     	  	 <td width="15%">手机号码:</td>
	    	  	     	  	 <td><input type="text" name="mobile" value="${addr.mobile }"/>  </td>    	  	     	  	 
	    	  	     	  </tr> 
	    	  	     	  <tr>
	    	  	     	  	 <td width="15%">固定电话:</td>
	    	  	     	  ...
	    	  	     	  <tr>
	    	  	     	  	 <td width="15%"> QQ:</td>
	    	  	     	  	 <td><input type="text" name="qq" size="16" value="${addr.qq }"/>  </td>    	  	     	  	 
	    	  	     	  </tr> 
	    	  	     	  <tr>
	    	  	     	  	 <td width="15%"> Email:</td>
	    	  	     	  	 <td><input type="text" name="email" size="35" value="${addr.email }"/>  </td>    	  	     	  	 
	    	  	     	  </tr> 
	    	  	     	   <tr>
	    	  	     	  	 <td width="15%"> 所属分组:</td>
	    	  	     	  	 <td>
