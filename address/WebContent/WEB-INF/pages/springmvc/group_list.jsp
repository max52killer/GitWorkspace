    	     ...
    	     <div id="right">
    	  	    <div class="rightMenuTitle">
    	  	     ...
    	  	     <table>
    	  	     	  ...
    	  	     	  <c:forEach  var="group" items="${pb.rows }">
    	  	     	    <tr>
    	  	     	  	 <td>${group.name }</td>
    	  	     	  	 <td>${group.descs }</td>
    	  	     	  	 <td>${group.user.username}</td>
    	  	     	  	 <td> <a href="group/${group.id }/edit"><img src="img/icon-edit.gif"/></a> </td>
    	  	     	  	 <td> <a href="group/${group.id }/delete" onclick="return confirm('确定要删除吗?')"><img src="img/radio.GIF"/></a> </td>
    	  	     	   </tr>
    	  	     	  </c:forEach>
    	  	     	  	...
    	  	     	  	<td colspan="8" align="right">
    	  	     	  		 <div class="pager">
    	  	     	  		  ...
    	  	     	  		  <c:choose>
    	  	     	  		      ...
    	  	     	  		      <c:otherwise>
    	  	     	  		          <a href="group/list/page-1">首页 </a> <a  href="group/list/page-${pb.page-1 }">上一页  </a>
    	  	     	  		      </c:otherwise>
    	  	     	  		  </c:choose>
    	  	     	  		<c:choose>
    	  	     	  		   <c:when test="${pb.last }"> 下一页 尾页</c:when>
    	  	     	  		   <c:otherwise>
    	  	     	  		      <a href="group/list/page-${pb.page+1 }">下一页</a> <a href="group/list/page-${pb.pageCount }">尾页</a>
    	  	     	  		   </c:otherwise>
    	  	     	  		</c:choose>
    	  	     	  		  <select onchange="location.href='group/list/page-' + this.value">
