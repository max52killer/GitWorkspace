    	  ...
    	  <div id="center">
    	  	 <div id="left">
    	  	      ...
    	  	      <dl class="menuList">
    	  	      	 ...
    	  	      	 <dd><a href="">功能三</a></dd>    	  	      	
    	  	      	 <dt>系统维护</dt>
    	  	      	 <dd><a href="user/edit">修改登录密码</a></dd>
    	  	      	 <dd><a href="">功能二</a></dd>
    	  	      	 <dd><a href="">功能三</a></dd>    	  	      
    	  	      </dl>
    	     </div>
    	     <div id="right">
    	  	    <div class="rightMenuTitle">
    	  	     ...
    	  	     <form action="user/edit/pwdup"  method="post">
    	  	         <input type="hidden" name="id" value="${user.id }"/>
	    	  	     <table>	    	  	     	  
	    	  	     	  <tr>
	    	  	     	  	 <td width="18%">用户名:</td>
	    	  	     	  	 <td><input type="text" name="username" value="${user.username }" size="10" readonly="readonly"/> * </td>    	  	     	  	 
	    	  	     	  </tr> 
	    	  	     	  <tr>
	    	  	     	  	 <td width="18%">用户原密码:</td>
	    	  	     	  ...
	    	  	     	  <tr>
	    	  	     	  	 <td width="18%">确认密码:</td>
	    	  	     	  	 <td><input type="password" name="newpwd1" value="${newpwd1}"/>  </td>    	  	     	  	 
	    	  	     	  </tr> 
	    	  	     	   <tr>
	    	  	     	  	 <td width="18%"></td>
