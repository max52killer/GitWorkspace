    	  	    ...
    	  	    <div class="rightMenuTitle">
    	  	     ...
    	  	     <form action="address_add.action"  method="post">
	    	  	     <table>	    	  	     	  
	    	  	     	  ...
	    	  	     	  <tr>
	    	  	     	  	 <td width="15%">手机号码:</td>
	    	  	     	  	 <td><input type="text" name="addr.mobile" />  </td>    	  	     	  	 
	    	  	     	  </tr> 
	    	  	     	  <tr>
	    	  	     	  	 <td width="15%">固定电话:</td>
	    	  	     	  	 <td><input type="text" name="addr.phone" />  </td>    	  	     	  	 
	    	  	     	  </tr>  
	    	  	     	  <tr>
	    	  	     	  	 <td width="15%"> QQ:</td>
	    	  	     	  	 <td><input type="text" name="addr.qq" size="16" />  </td>    	  	     	  	 
	    	  	     	  </tr> 
	    	  	     	  <tr>
	    	  	     	  	 <td width="15%"> Email:</td>
	    	  	     	  	 <td><input type="text" name="addr.email" size="35" />  </td>    	  	     	  	 
	    	  	     	  </tr> 
	    	  	     	   <tr>
	    	  	     	  	 <td width="15%"> 所属分组:</td>
	    	  	     	  	 <td>
