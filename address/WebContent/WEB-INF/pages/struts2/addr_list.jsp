...
<body>
    <div id="container">
    	  ...
    	  <div id="topMenu">
    	  	  ...
    	  	  <span id="exit"><a href="login_logout.action">退出系统</a></span>
    	  </div>
    	  	     ...
    	  	     <table>
    	  	     	  ...
    	  	     	  <c:forEach  var="addr" items="${pb.rows }">
    	  	     	    <tr>
    	  	     	  	 ...
    	  	     	  	 <td> <a href="address_preEdit.action?id=${addr.id }"><img src="img/icon-edit.gif"/></a> </td>
    	  	     	  	 <td> <a href="address_delete.action?id=${addr.id }" onclick="return confirm('确定要删除吗?')"><img src="img/radio.GIF"/></a> </td>
    	  	     	   </tr>
    	  	     	  </c:forEach>
    	  	     	  	...
    	  	     	  	<td colspan="8" align="right">
    	  	     	  		 <div class="pager">
    	  	     	  		  ...
    	  	     	  		  <c:choose>
    	  	     	  		      ...
    	  	     	  		      <c:otherwise>
    	  	     	  		          <a href="address_list.action?page=1">首页 </a> <a  href="address_list.action?page=${pb.page-1 }">上一页  </a>
    	  	     	  		      </c:otherwise>
    	  	     	  		  </c:choose>
    	  	     	  		<c:choose>
    	  	     	  		   <c:when test="${pb.last }"> 下一页 尾页</c:when>
    	  	     	  		   <c:otherwise>
    	  	     	  		      <a href="address_list.action?page=${pb.page+1 }">下一页</a> <a href="address_list.action?page=${pb.pageCount }">尾页</a>
    	  	     	  		   </c:otherwise>
    	  	     	  		</c:choose>
    	  	     	  		  <select onchange="location.href='address_list.action?page=' + this.value">
